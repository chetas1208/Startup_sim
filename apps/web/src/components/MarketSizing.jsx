...
export default function MarketSizing({ data }) {
  if (!data) return null;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Concentric Circles — labels offset into each ring band */}
        <div className="flex items-center justify-center py-8">
          <div className="relative" style={{ width: 288, height: 288 }}>
            ...
            {/* SAM ring */}
            <div className="absolute rounded-full border-2 border-sg-accent/50 bg-sg-accent/10"
                 style={{ inset: 52 }} />
            ...
            {/* SOM ring */}
            <div className="absolute rounded-full border-2 border-sg-accent bg-sg-accent/20
